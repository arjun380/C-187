...
firebase = firebase.FirebaseApplication("https://metal-ranger-350209-default-rtdb.firebaseio.com/",None)
login_window = Tk()
...
def getData() :
    ...
    get_your_code = firebase.get('/', your_code)
    print(get_your_data)
    ...
    if(get_friends_data != None):
        ...
        original = decrypt('AIM', byte_str)
        final_message = original.decode("utf-8")
        if (final_message not in last_volume):
            print(final_message)
